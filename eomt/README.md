...
```bash
python .\eomt\main.py validate -c eomt/configs/dinov2/cityscapes/semantic/eomt_large_640.yaml --model.network.masked_attn_enabled False --trainer.devices 4 --data.batch_size 4 --data.path eomt/Anomaly_Validation_Datasets.zip --model.ckpt_path eomt/eomt_cityscapes.bin
```
